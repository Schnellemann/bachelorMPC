...
func TestParseExpressionAddOld(t *testing.T) {
	toConvert := "p1+p2"
...
func TestParseExpressionMulOld(t *testing.T) {
	toConvert := "p1*p2"
	exp := ParseExpression(toConvert)
	res, instructions, _ := ConvertAstToExpressionList(exp)
	if len(instructions) != 1 {
...
func TestParseExpressionScalarOld(t *testing.T) {
	toConvert := "1*p1"
	exp := ParseExpression(toConvert)
	res, instructions, _ := ConvertAstToExpressionList(exp)
	if len(instructions) != 1 {
...
func TestParseExpressionCombinedOld(t *testing.T) {
...
func TestParseExpressionBigCombinedOld(t *testing.T) {
